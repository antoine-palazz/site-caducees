...
// Inline translations for 404 page
const translations = {
  fr: {
...
// Global 404 page - needs its own HTML structure since root layout is a passthrough
export default function NotFound() {
  const pathname = usePathname()
  
  // Try to extract locale from pathname, fallback to default
