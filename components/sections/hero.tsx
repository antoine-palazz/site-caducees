  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <h1 className="animate-fade-in-up stagger-1 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-foreground mb-6 leading-tight text-balance">
          <span className="block">Les</span>
          <span className="block text-gold font-serif italic">Caducées</span>
        </h1>

        <p className="animate-fade-in-up stagger-2 max-w-2xl mx-auto text-lg sm:text-xl text-muted-foreground mb-10 leading-relaxed text-pretty">
          {siteConfig.tagline}
        </p>
        ...
        <div className="animate-fade-in-up stagger-3 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="border-border text-foreground hover:bg-muted min-w-[180px] bg-transparent"
          >
